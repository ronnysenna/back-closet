...
var prisma = prisma_js_1.default.default || prisma_js_1.default;
function cleanTestOrders() {
    return __awaiter(this, void 0, void 0, function () {
        var testUsers, testUserIds, orConditions, deleted;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    testUsers = _a.sent();
                    testUserIds = testUsers.map(function (u) { return u.id; });
                    orConditions = [
                ...
                case 2:
                    deleted = _a.sent();
                    console.log("Pedidos de teste removidos: ".concat(deleted.count));
                    return [2 /*return*/];
            }
        });
    });
