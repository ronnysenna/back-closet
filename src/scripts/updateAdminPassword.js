...
function updateAdminPassword() {
    return __awaiter(this, void 0, void 0, function () {
        var email, newPassword, existingUser, saltRounds, hashedPassword, updatedUser, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, 5, 7]);
                    email = "admin@lojaon.com";
                ...
                case 1:
                    ...
                    if (!existingUser) {
                        console.log("Usu\u00E1rio com email ".concat(email, " n\u00E3o existe."));
                        return [2 /*return*/];
                    }
                    saltRounds = 10;
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error("Erro ao atualizar senha do administrador:", error_1);
                    return [3 /*break*/, 7];
                case 5: return [4 /*yield*/, prisma_js_1.default.$disconnect()];
                case 6:
                    _a.sent();
                    return [7 /*endfinally*/];
