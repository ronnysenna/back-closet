...
exports.cancelOrder =
  exports.updateTrackingNumber =
  exports.updateOrderPaymentMethod =
  exports.updateOrderNotes =
  exports.updateOrderStatus =
  exports.getOrderByNumber =
...
exports.createOrder = async (req, res) => {
  ...
  try {
    ...
    const order = await prisma_js_1.default.$transaction(async (tx) => {
      // Verificar se todos os produtos têm estoque suficiente antes de criar o pedido
      for (const item of items) {
        ...
        if (!product || product.stockQuantity < item.quantity) {
          throw new Error(
            `Produto '${item.name}' esgotado ou estoque insuficiente.`
          );
        }
      }
...
var getMyOrders = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            prisma_js_1.default.order.findUnique({
              where: {
                id: parseInt(id),
              },
              include: {
...
var getOrderByNumber = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            prisma_js_1.default.order.update({
              where: {
                id: parseInt(id),
              },
              data: updateData,
...
var updateOrderPaymentMethod = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    var id,
      _a,
      paymentMethod,
...
var updateTrackingNumber = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
              ...
              data: {
                ...
                notes: existingOrder.notes
                  ? ""
                      ...
                      .concat(new Date().toISOString(), "] Pedido cancelado ")
                      .concat(
